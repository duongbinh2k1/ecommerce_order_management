...
class TestOrderProcessingIntegration(unittest.TestCase):
    ...
    def _setup_test_suppliers(self):
    ...
    def test_successful_order_creation_gold_member(self):
    ...
    def test_successful_order_with_promotion(self):
    ...
    def test_order_failure_insufficient_stock(self):
    ...
    def test_order_failure_invalid_payment(self):
    ...
    def test_order_failure_expired_promotion(self):
        ...
        self.assertGreaterEqual(order.total_price, 29.99)
    ...
    def test_sales_report_generation(self):
        ...
        self.assertGreaterEqual(report['total_orders'], 2)
        self.assertIn('Electronics', report['revenue_by_category'])
