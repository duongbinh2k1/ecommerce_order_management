...
class TestCustomerService(unittest.TestCase):
    ...
    def test_get_customer_not_found(self):
        ...
        result = self.customer_service.get_customer("nonexistent")
        
        self.assertIsNone(result)
        self.mock_repository.get.assert_called_once_with("nonexistent")
    ...
    def test_add_loyalty_points_customer_not_found(self):
        """Test adding loyalty points to non-existent customer."""
        self.mock_repository.get.return_value = None
        
        result = self.customer_service.add_loyalty_points("nonexistent", 50)
        
        self.assertFalse(result)
        self.mock_repository.get.assert_called_once_with("nonexistent")
        self.mock_repository.update.assert_not_called()

    def test_upgrade_membership_success(self):
    ...
    def test_upgrade_membership_customer_not_found(self):
        """Test upgrading membership for non-existent customer."""
        self.mock_repository.get.return_value = None
        
        result = self.customer_service.upgrade_membership("nonexistent", MembershipTier.GOLD)
        
        self.assertFalse(result)
        self.mock_repository.get.assert_called_once_with("nonexistent")
        self.mock_repository.update.assert_not_called()

    def test_auto_upgrade_membership_qualifies_for_gold(self):
    ...
    def test_auto_upgrade_membership_qualifies_for_silver(self):
    ...
    def test_auto_upgrade_membership_no_upgrade_needed(self):
