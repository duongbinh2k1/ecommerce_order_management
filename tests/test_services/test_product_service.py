...
class TestProductService(unittest.TestCase):
    ...
    def test_get_product_not_found(self):
        ...
        # Get product
        result = self.product_service.get_product("nonexistent")
        
        # Verify result
        self.assertIsNone(result)
        self.mock_repository.get.assert_called_once_with("nonexistent")

    def test_update_product_price_success(self):
    ...
    def test_get_all_products(self):
        ...
        # Mock repository return
        expected_products = {
            "1": Product("1", "Product 1", 99.99, 10, "Electronics", 1.0, "supplier1"),
            "2": Product("2", "Product 2", 199.99, 5, "Electronics", 2.0, "supplier2")
        }
