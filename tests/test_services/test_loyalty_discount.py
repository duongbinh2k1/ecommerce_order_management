...
class TestLoyaltyPointsDiscountStrategy(unittest.TestCase):
    ...
    def test_calculate_discount_insufficient_points(self):
    ...
    def test_calculate_discount_minimum_points(self):
    ...
    def test_calculate_discount_within_limit(self):
    ...
    def test_calculate_discount_exceeds_limit(self):
    ...
    def test_calculate_discount_large_subtotal(self):
    ...
    def test_calculate_discount_exact_limit(self):
    ...
    def test_calculate_discount_zero_subtotal(self):
    ...
    def test_calculate_discount_float_precision(self):
